...
void main() {
  group('Logs', () {
    ...
    test('should limit the number of stored logs', () {
      ...
      expect(logs
          .getStoredLogs()
          .first['message'], 'Verbose message 2');
      expect(logs
          .getStoredLogs()
          .last['message'], 'Verbose message 3');
    });
